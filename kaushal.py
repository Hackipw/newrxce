...
expirydate = datetime.date(2021, 11, 1)
...
if(expirydate>today):
    ...
    if (False):
        ...
        print(" admin on telegram @RXCE_HACKING ")
        ("Channel join krle bhosdke😁 @RXCE_HACKING")
        print( "Msg me on telegram @RXCE_HACKING")
        banner='figlet RXCE_HACKING'
        print("play at your own risk please don't blame owner on any loss")
